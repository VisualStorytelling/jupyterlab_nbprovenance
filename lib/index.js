    ...
    nbTracker.widgetAdded.connect((_, nbPanel) => {
        ...
        nbPanel.sessionContext.ready.then(() => {
            ...
            if (!exports.notebookModelCache.has(notebook)) {
                exports.notebookModelCache.set(notebook, new notebook_provenance_1.NotebookProvenance(app, notebook, nbPanel.sessionContext, nbPanel.context));
            }
        });
    });
    const provenanceView = new side_bar_1.SideBar(app.shell, nbTracker);
