...
class NotebookProvenanceTracker {
    ...
    trackCellExecution() {
        ...
        notebook_1.NotebookActions.executed.connect((_dummy, obj) => {
            ...
            let action = this.notebookProvenance.prov.addAction("Cell executed", (state) => {
    ...
    trackCellsChanged() {
        ...
        const cellsChangedListener = (list, change) => {
            ...
            switch (change.type) {
                case 'add':
                    action = this.notebookProvenance.prov.addAction("Cell added", (state) => {
                    ...
                    break;
                case 'remove':
                    action = this.notebookProvenance.prov.addAction("Cell removed", (state) => {
                        state.cellValue = currentCell.value.text;
                        state.cellType = currentCell.type;
                        state.moveToIndex = notebook.activeCellIndex;
                        state.activeCell = notebook.activeCellIndex;
                    ...
                    break;
                case 'move':
                    action = this.notebookProvenance.prov.addAction("Cell moved", (state) => {
                        state.cellValue = currentCell.value.text;
                        state.cellType = currentCell.type;
                        state.moveToIndex = notebook.activeCellIndex;
                        state.activeCell = notebook.activeCellIndex;
                ...
                case 'set': // caused by, e.g., change cell type
                    action = this.notebookProvenance.prov.addAction("Cell type changed", (state) => {
                        state.cellValue = currentCell.value.text;
                        state.cellType = currentCell.type;
                        state.moveToIndex = notebook.activeCellIndex;
                        state.activeCell = notebook.activeCellIndex;
