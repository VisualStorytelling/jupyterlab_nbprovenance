...
function bundleTransitions(xOffset, yOffset, clusterOffset, backboneOffset, duration = 500, expandedClusterList, stratifiedMap, nodeList, annotationOpen, annotationHeight, bundleMap) {
    xOffset = -xOffset;
    ...
    const enter = (data) => {
        let validity = true;
        const x = LinkTransitions_1.getX(stratifiedMap[data].width, xOffset, backboneOffset);
