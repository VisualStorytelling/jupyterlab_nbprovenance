...
const nb = __importStar(require("@jupyterlab/notebook"));
const handler = {
...
exports.originalNotebookActions = {};
...
for (const prop in nb.NotebookActions) {
    if (proxiedActions.has(prop)) {
        exports.originalNotebookActions[prop] = nb.NotebookActions[prop];
        nb.NotebookActions[prop] = new Proxy(exports.originalNotebookActions[prop], handler);
    }
}
//# sourceMappingURL=action-listener.js.map